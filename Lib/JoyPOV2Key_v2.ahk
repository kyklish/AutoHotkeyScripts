...
;   #Include <JoyPOV2Key_v2> ; Use above line or this, but not both.
;
...
;   WatchPOV := Func("JoyPOV2Key").Bind("w", "a", new Command1, new Command2, JoyNumber)
...
class CommandN ; each class for each POV button
{
    ...
    Down()
    {
        ;do stuff on pressing button
    }

    Up()
    {
        ;do stuff on releasing button
    }
}
*/
