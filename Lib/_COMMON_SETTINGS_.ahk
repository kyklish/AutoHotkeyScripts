...
SetKeyDelay -1 ;Sets the delay that will occur after each keystroke sent by Send and ControlSend. -//- The default delay for the tradional SendEvent mode is 10. For SendPlay mode, the default delay is -1. The default PressDuration (below) is -1 for both modes.
