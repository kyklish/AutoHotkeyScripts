...
FindSlotsCoordinates()
{
	...
	; при добавлении 8го слота размер рамки не меняется, уменьшается расстояние между иконками расстений
	...
	; 7мь слотов опроверяем по пикселю перед 7ой иконкой растения, елси это цвет фона, значит у нас 7мь слотов (если нет, значит иконки стоят плотнее и нужна проверка на 8мь слотов)
	; 8мь слотов аналогично определяем по пикселю перед 8ой иконкой растения
	global Xcard, slots
	backgroundColor := 0x6E3213 ; цвет фона, на котором распалогаются иконки растений
